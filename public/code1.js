...
gdjs.gameCode.userFunc0x872c40 = function(runtimeScene, objects) {
"use strict";
...
gdjs.gameCode.userFunc0x872c40(runtimeScene, objects);
...
gdjs.gameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9335252);
}
}}
...
gdjs.gameCode.userFunc0x7fbe70 = function(runtimeScene, objects) {
"use strict";
function angleReflect(incidenceAngle, surfaceAngle){
  const a = surfaceAngle * 2 - incidenceAngle;
  return a >= 360 ? a - 360 : a < 0 ? a + 360 : a;
...
gdjs.gameCode.userFunc0x7fbe70(runtimeScene, objects);
...
{
{gdjs.gameCode.conditionTrue_1 = gdjs.gameCode.condition1IsTrue_0;
gdjs.gameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9337812);
}
}}
if (gdjs.gameCode.condition1IsTrue_0.val) {
/* Reuse gdjs.gameCode.GDplayerObjects1 */
